...
build_arm5:
	GOOS=linux GOARM=5 GOARCH=arm go build -a -o ./build/atnetgo *.go
	zip ./build/atnetgo_linux_arm5.zip ./build/atnetgo

build_arm7:
	GOOS=linux GOARM=7 GOARCH=arm go build -a -o ./build/atnetgo *.go
	zip ./build/atnetgo_linux_arm7.zip ./build/atnetgo

build_win64:
	GOOS=windows GOARCH=amd64 go build -a -o ./build/atnetgo.exe *.go
	zip ./build/atnetgo_win64.zip ./build/atnetgo.exe

build_win32:
	GOOS=windows GOARCH=386 go build -a -o ./build/atnetgo.exe *.go
